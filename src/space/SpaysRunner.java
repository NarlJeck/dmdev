 ...
 */
public class SpaysRunner {
    public static void main(String[] args) {
        Planet jupiter = new Planet("Водород, Гелий",60,"Jupiter",20000,
                1300.3,2000.33,110,6000000000.8,
                50.5,10,22.5);

        Planet x24 = new Planet("Водород, Гелий",50,"x24r",5000,
                2000.3,1800.33,200,600000000.8,
                20.5,1,12.5);

        jupiter.compareMass(jupiter,x24);
        System.out.println(SpaceUtils.findingGravityBetweenBodies(jupiter,x24));
        System.out.println(SpaceUtils.definitionStarOrNot(x24));

        Satellite moon = new Satellite("Гелий",2,"Moon",42201,444.5,
